...
class GetLogReminderSettingsUseCase {
  GetLogReminderSettingsUseCase({required this._logRemindersRepository});

  final LogRemindersRepository _logRemindersRepository;

  LogReminderSettings call() => _logRemindersRepository.getLogReminderSettings();
}
