...
class DietPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocProvider<DietCubit>(
    create: (context) => G<DietCubit>()..loadToday(),
    child: VTPage<DietCubit, DietState>(
      builder: (context, cubit, state) {
        final l10n = AppLocalizations.of(context);
        return Scaffold(
          appBar: AppBar(title: Text(l10n.dietFeatureTitle)),
          body: switch (state) {
            DietLoading() => const VTLoadingIndicator(),
