...
class WorkoutDateSelector extends StatelessWidget {
  const WorkoutDateSelector({required this.date, required this.canGoToNextDay, required this.onPreviousDay, required this.onNextDay, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        IconButton(icon: const Icon(Icons.chevron_right), tooltip: l10n.workoutNextDayTooltip, onPressed: canGoToNextDay ? onNextDay : null),
      ],
    );
  }
