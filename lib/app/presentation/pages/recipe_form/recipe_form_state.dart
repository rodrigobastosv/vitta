...
class RecipeFormState extends Equatable {
  ...
  RecipeFormState copyWith({RecipeDraft? draft, Uint8List? imageBytes, String? imageExtension}) =>
      RecipeFormState(draft: draft ?? this.draft, imageBytes: imageBytes ?? this.imageBytes, imageExtension: imageExtension ?? this.imageExtension);
