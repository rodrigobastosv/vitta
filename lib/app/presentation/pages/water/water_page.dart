...
class WaterPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocProvider<WaterCubit>(
    create: (context) => G<WaterCubit>()..loadToday(),
    child: VTPage<WaterCubit, WaterState>(
      builder: (context, cubit, state) {
        ...
        return Scaffold(
          ...
          body: switch (state) {
            WaterLoading() => const VTLoadingIndicator(),
