...
class HomeHero extends StatelessWidget {
  ...
  final ValueChanged<Reminder> onCompleteReminder;
  ...
  Widget build(BuildContext context) => switch (feature) {
    ...
    .reminders => HomeRemindersHero(openReminders: state.openReminders, onTap: _open, onComplete: onCompleteReminder),
    .workout => HomeWorkoutHero(
    ...
    .sleep => HomeSleepHero(lastNightHours: state.lastNightHours, goalHours: sleepGoalHours, onTap: _open, onLog: onLogSleep),
    .bodyWeight => HomeBodyWeightHero(
