...
class OnboardingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      BlocProvider<OnboardingCubit>(create: (context) => G<OnboardingCubit>(), child: const _OnboardingView());
}
...
class _OnboardingView extends StatelessWidget {
  ...
  void _showCreateAccountComingSoon(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l10n.onboardingCreateAccountComingSoonMessage)));
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => _showCreateAccountComingSoon(context),
