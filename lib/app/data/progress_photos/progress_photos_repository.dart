...
class ProgressPhotosRepository {
  ...
  Future<Result<VTError, ProgressPhoto>> createPhoto({required String storagePath, required DateTime takenDate, String? note}) =>
      _supabaseProgressPhotosDataSource.createPhoto(storagePath: storagePath, takenDate: takenDate, note: note);
