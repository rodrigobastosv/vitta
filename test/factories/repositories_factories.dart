...
abstract class RepositoriesFactories {
  static DietRepository buildDietRepository({
    ...
    MockSupabaseMealSuggestionDataSource? supabaseMealSuggestionDataSource,
    ...
    supabaseMealSuggestionDataSource: supabaseMealSuggestionDataSource ?? MockSupabaseMealSuggestionDataSource(),
